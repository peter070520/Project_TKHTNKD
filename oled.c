...
#define I2C_MASTER_SCL_OLED 22               /*!< gpio number for I2C master clock */
#define I2C_MASTER_SDA_OLED 21               /*!< gpio number for I2C master data  */
...
void task_ssd1306_display_text(const void *arg_text, uint8_t cur_page[]) {
	...
	i2c_master_write_byte(cmd, 0xB0 | ++cur_page[0], true); // reset page
	...
	for (uint8_t i = 0; i < text_len; i++) {
		if ((i+1)%17 == 0 && text[i] != '\n')
		{
			...
			i2c_master_write_byte(cmd, 0xB0 | ++cur_page[0], true); // increment page
...
/* void display(const void *arg_text)
{
	char *text = (char*)arg_text;
	uint8_t text_len = strlen(text);
	if (text_len >= 16)
